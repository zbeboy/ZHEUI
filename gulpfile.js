...
// 创建一个任务确保files任务完成之前能够继续响应
// 浏览器重载
gulp.task('files-watch',['files'],browserSync.reload);
...
gulp.task('serve', ['js','css','images','fonts','font','icon','html','ui','files'], function () {
